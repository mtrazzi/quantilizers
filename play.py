...
def play_1d(env, fps=30, zoom=None, callback=None, keys_to_action=None, save=False, filename='traj.npz'):
    ...
    while running:
        ...
        if obs is not None:
            ...
            #display_arr(screen, obs, video_size=video_size)
            env.render()
            #print(obs)
    ...
    if save:
        ...
        #data_save['acs'] = pad2d(data_save['acs'], (n_eps, ep_length)) #for 1d task
...
if __name__ == '__main__':
    ...
    play_1d(env, callback=plotter.data_callback, zoom=4, fps=60)
